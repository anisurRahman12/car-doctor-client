    ...
    return (
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <img
            src={img2}
            className="w-full" />
          <div className="absolute flex items-center h-full left-0 right-0     justify-end bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
            <div className='text-white pl-48 space-y-7'>
